...
export const OrgPieChartInfo: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const OrgPieChartSeries = [
    { name: "Three Gen", value: 5, color: (getColorValue("1") as any) || undefined },
    { name: "Health Med Pro", value: 10, color: (getColorValue("3") as any) || undefined },
    { name: "Encipher Health", value: 13, color: (getColorValue("6") as any) || undefined },
    { name: "Vanguard", value: 6, color: (getColorValue("4") as any) || undefined },
    { name: "Cogent Health", value: 15, color: (getColorValue("2") as any) || undefined },
  ];
  const {
...
export const AllocatedStatus: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const allocatedSeries = [
    { name: "Allocated", value: 210, color: (getStatusColor("1") as any) || undefined },
    { name: "Not Allocated", value: 0, color: (getStatusColor("2") as any) || undefined },
  ];
...
export const Coder1: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const coder1Series = [
    { name: "Allocated", value: 2, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 3, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 5, color: (getStatusColor("3") as any) || undefined },
  ];
...
export const Coder2: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const coder2Series = [
    { name: "Allocated", value: 3, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 2, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 5, color: (getStatusColor("3") as any) || undefined },
  ];
  const {
...
export const QA: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const QASeries = [
    { name: "Allocated", value: 3, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 6, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 2, color: (getStatusColor("3") as any) || undefined },
  ];
  const {
...
export const ProjectLead: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const PLSeries = [
    { name: "Allocated", value: 3, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 7, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 4, color: (getStatusColor("7") as any) || undefined },
    { name: "ReassignedPending", value: 2, color: (getStatusColor("4") as any) || undefined },
    { name: "ReassignedCompleted", value: 7, color: (getStatusColor("5") as any) || undefined },
    { name: "QueriedApproved", value: 4, color: (getStatusColor("3") as any) || undefined },
    { name: "QueriedPending", value: 2, color: (getStatusColor("6") as any) || undefined },
  ];
  const {
...
export const QALead: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const QALeadSeries = [
    { name: "Allocated", value: 3, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 6, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 3, color: (getStatusColor("7") as any) || undefined },
    { name: "ReassignedPending", value: 7, color: (getStatusColor("4") as any) || undefined },
    { name: "ReassignedCompleted", value: 8, color: (getStatusColor("5") as any) || undefined },
    { name: "QueriedApproved", value: 9, color: (getStatusColor("3") as any) || undefined },
    { name: "QueriedPending", value: 10, color: (getStatusColor("6") as any) || undefined },
  ];
  const {
...
export const Owner: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const OwnerSeries = [
    { name: "Allocated", value: 5, color: (getStatusColor("1") as any) || undefined },
    { name: "Completed", value: 3, color: (getStatusColor("2") as any) || undefined },
    { name: "InProgress", value: 8, color: (getStatusColor("7") as any) || undefined },
    { name: "ReassignedPending", value: 2, color: (getStatusColor("4") as any) || undefined },
    { name: "ReassignedCompleted", value: 8, color: (getStatusColor("5") as any) || undefined },
    { name: "QueriedApproved", value: 3, color: (getStatusColor("3") as any) || undefined },
    { name: "QueriedPending", value: 6, color: (getStatusColor("6") as any) || undefined },
  ];
  const {
...
export const Users: React.FC<ChartProps> = ({ chartType, chartChange }) => {
  const UsersSeries = [
    { name: "Admin", value: 2, color: (getRoleColor("1") as any) || undefined },
    { name: "Coder 1", value: 6, color: (getRoleColor("2") as any) || undefined },
    { name: "Coder 2", value: 8, color: (getRoleColor("3") as any) || undefined },
    { name: "QA", value: 12, color: (getRoleColor("4") as any) || undefined },
    { name: "QA Lead", value: 4, color: (getRoleColor("5") as any) || undefined },
    { name: "Project Lead", value: 13, color: (getRoleColor("6") as any) || undefined },
    { name: "Owner", value: 6, color: (getRoleColor("7") as any) || undefined },
  ];
  const {
...
export const Accuracy: React.FC<AccuracyProps> = ({ chartType, chartChange, series }) => {
  ...
  const accuracyChart = [
    { name: "Total Codes Count", data: [{ date: "2026-01-04", value: 7 }, { date: "2026-01-05", value: 18 }, { date: "2026-01-06", value: 10 }, { date: "2026-01-07", value: 25 }, { date: "2026-01-08", value: 14 }, { date: "2026-01-09", value: 9 }, { date: "2026-01-10", value: 22 }], color: (getColorValue("1") as any) || undefined, type: "column" },
    { name: "Engine Score", data: [{ date: "2026-01-04", value: 70 }, { date: "2026-01-05", value: 90 }, { date: "2026-01-06", value: 78 }, { date: "2026-01-07", value: 100 }, { date: "2026-01-08", value: 82 }, { date: "2026-01-09", value: 74 }, { date: "2026-01-10", value: 88 }], color: (getColorValue("2") as any) || undefined, type: "spline" },
  ];

  const productivityChart = [
    { name: "Add", type: "column", color: (getColorValue("1") as any) || undefined, stack: "allocation", data: [{ date: "2026-01-04", pendingCount: 15 }, { date: "2026-01-05", pendingCount: 9 }, { date: "2026-01-06", pendingCount: 14 }, { date: "2026-01-07", pendingCount: 11 }, { date: "2026-01-08", pendingCount: 17 }, { date: "2026-01-09", pendingCount: 8 }, { date: "2026-01-10", pendingCount: 20 }], plotConfig: { key: "date", value: "pendingCount" } },
    { name: "Edit", type: "column", color: (getColorValue("2") as any) || undefined, stack: "allocation", data: [{ date: "2026-01-04", completedCount: 35 }, { date: "2026-01-05", completedCount: 40 }, { date: "2026-01-06", completedCount: 32 }, { date: "2026-01-07", completedCount: 38 }, { date: "2026-01-08", completedCount: 29 }, { date: "2026-01-09", completedCount: 33 }, { date: "2026-01-10", completedCount: 41 }], plotConfig: { key: "date", value: "completedCount" } },
    { name: "Accuracy %", type: "spline", color: (getColorValue("3") as any), data: [{ date: "2026-01-04", accuracyScore: 91 }, { date: "2026-01-05", accuracyScore: 86 }, { date: "2026-01-06", accuracyScore: 89 }, { date: "2026-01-07", accuracyScore: 93 }, { date: "2026-01-08", accuracyScore: 88 }, { date: "2026-01-09", accuracyScore: 84 }, { date: "2026-01-10", accuracyScore: 92 }], plotConfig: { key: "date", value: "accuracyScore" } },
  ];
    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      {series === "Accuracy" && (
        <div className="col-span-3">
          <div className="p-4 border border-gray-200 rounded bg-blue-50 text-center">
...
export const allocationStatusData = ({ chartType }: ChartProps) => [
  {
    ...
    series: [
      { name: "Allocated", data: [10, 20, 30, 40, 50, 60, 70], color: (getColorValue("2") as any) || undefined, stack: "same" },
      { name: "Pending", data: [2, 6, 9, 3, 5, 7, 8], color: (getColorValue("3") as any) || undefined, stack: "same" },
      { name: "Completed", data: [8, 14, 21, 37, 45, 53, 62], color: (getColorValue("1") as any) || undefined, stack: "same" },
    ],
  },
];

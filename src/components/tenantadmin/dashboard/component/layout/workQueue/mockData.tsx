...
import { Buttons } from "@/components/tenantadmin/dashboard/pages/workQueue/constants";
      ...
      <div className="mx-auto">
        <div className="grid grid-cols-2 gap-2">
          {data.map((item: any, idx: number) => (
            <div className={idx === 0 ? "col-span-2" : "col-span-1"} key={idx}>
              <StatusCard
                key={idx}
                status={item.status}
                value={item.value}
...
export const DailyTask5 = ({
  ...
  return (
    <div className="flex gap-3 flex-wrap justify-between">
      ...
      <div className="my-2 flex w-full flex-wrap justify-center gap-4">
    ...
    return (
      <div className="mx-auto">
        <div className="grid grid-cols-1 gap-2">
          {data.map((item, idx) => (
            <div className={idx === 0 ? "w-full" : "w-1/2"} key={idx}>
              <StatusCard
                key={idx}
                status={item.status}
                value={item.value}
